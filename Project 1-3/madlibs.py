def storyChoice():
    while True:
        ...
        if storyOpt == "q":
            break
        if storyOpt == "1" or storyOpt == "2" or storyOpt == "3":
            wordChoice()
            break
        else:
...
coworker named " + noun1 + " who is very " + adj1 + ". Although one day he/she said my " + bodyPart + " looked weird and told me to lose weight. But other than that one time \
he/she is pretty chill and cool. Our work place is at " + location + " and I work from 9AM to " + number + "PM. It can be tiring but at the end of the day I get payed so it \
...
" + pNoun1 + " and " + noun1 + ". Time to get back to work. "
    ...
    print(storyList[int(storyOpt) - 1])
